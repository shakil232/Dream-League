    ...
    <div>
      <div className="cart mt-3">
        ...
        <p className="review "><i>
          <FontAwesomeIcon className="clipbboard" icon={faClipboard} />Team Summary </i></p>

        <h5 id="counter"><i>Total Players- <span className="counter mt-5">{cart.length}</span></i></h5>

        <p id="grand"><i>Total Budget- $ {GrandTransfer}<span className="grand mt-5"></span></i></p>
